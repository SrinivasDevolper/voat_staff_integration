...
router.post(
  ...
  ...jobseekerAuth,
  jobseekerController.upload.single("resume"),
  jobseekerController.multerErrorHandler,
...
router.get(
  "/notifications",
  ...jobseekerAuth,
  jobseekerController.getNotifications
);
router.put(
  "/notifications/:id/read",
  ...jobseekerAuth,
  jobseekerController.markNotificationRead
);
router.put(
  "/notifications/mark-all-read",
  ...jobseekerAuth,
  jobseekerController.markAllNotificationsRead
);
router.delete(
  "/notifications/:id",
  ...jobseekerAuth,
  jobseekerController.deleteNotification
);
router.get(
  "/notifications/upcoming",
  ...jobseekerAuth,
  jobseekerController.getUpcomingNotifications
);
